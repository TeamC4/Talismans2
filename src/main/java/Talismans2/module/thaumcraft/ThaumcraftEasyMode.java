...
//				new AspectList().add(Aspect.MAGIC, 5).add(Aspect.SENSES, 5), 0,
//				2, 1, new ResourceLocation(
...
//				new AspectList().add(Aspect.MAGIC, 5).add(Aspect.SENSES, 5), 2,
//				0, 1, new ResourceLocation(
...
//				new AspectList().add(Aspect.MAGIC, 5).add(Aspect.SENSES, 5),
//				-2, 0, 1, new ResourceLocation(
