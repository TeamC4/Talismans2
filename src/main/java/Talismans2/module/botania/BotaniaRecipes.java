...
public class BotaniaRecipes {
	...
	public static void init() {
		...
		flameTalisman = BotaniaAPI.registerRuneAltarRecipe(new ItemStack(
				ModItems.FlameTalisman, 1), 50000, new ItemStack(
		...
		waterTalisman = BotaniaAPI.registerRuneAltarRecipe(new ItemStack(
				ModItems.WaterTalisman, 1), 50000, new ItemStack(
				ModItems.BlankTalisman), new ItemStack(Blocks.waterlily),
				new ItemStack(Items.water_bucket), new ItemStack(Blocks.reeds));
		lightTalisman = BotaniaAPI.registerRuneAltarRecipe(new ItemStack(
				ModItems.LightTalisman, 1), 50000, new ItemStack(
		...
		miningTalisman = BotaniaAPI.registerRuneAltarRecipe(new ItemStack(
				ModItems.MiningTalisman, 1), 50000, new ItemStack(
		...
		movementTalisman = BotaniaAPI.registerRuneAltarRecipe(new ItemStack(
				ModItems.MovementTalisman, 1), 50000, new ItemStack(
				ModItems.BlankTalisman), new ItemStack(Items.diamond_boots),
				new ItemStack(Items.sugar), new ItemStack(Items.golden_apple));
		witherlessTalisman = BotaniaAPI.registerRuneAltarRecipe(new ItemStack(
				ModItems.WitherlessTalisman, 1), 50000, new ItemStack(
				ModItems.BlankTalisman), new ItemStack(Items.milk_bucket),
				new ItemStack(Items.nether_wart), new ItemStack(
						Items.golden_apple));
