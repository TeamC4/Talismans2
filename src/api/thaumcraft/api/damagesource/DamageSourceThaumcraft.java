...
public class DamageSourceThaumcraft extends DamageSource {
	...
	public static DamageSource taint = new DamageSourceThaumcraft("taint")
	...
	public static DamageSource causeSwarmDamage(
			EntityLivingBase par0EntityLiving) {
		return new EntityDamageSource("swarm", par0EntityLiving);
	}

	public static DamageSource causeTentacleDamage(
			EntityLivingBase par0EntityLiving) {
