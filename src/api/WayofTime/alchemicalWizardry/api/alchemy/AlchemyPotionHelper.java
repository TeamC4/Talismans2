...
public class AlchemyPotionHelper {
	...
	public AlchemyPotionHelper(int potionID, int tickDuration,
			int concentration, int durationFactor) {
	...
	public PotionEffect getPotionEffect() {
		...
		return (new PotionEffect(potionID, (int) (tickDuration
				* Math.pow(0.5f, concentration) * Math.pow(8.0f / 3.0f,
				durationFactor)), concentration));
	}

	public static AlchemyPotionHelper readEffectFromNBT(
			NBTTagCompound tagCompound) {
		return new AlchemyPotionHelper(tagCompound.getInteger("potionID"),
