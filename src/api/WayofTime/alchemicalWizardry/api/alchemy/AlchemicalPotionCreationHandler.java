...
public class AlchemicalPotionCreationHandler {
	...
	public static void addPotion(ItemStack itemStack, int potionID,
			int tickDuration) {
		registeredPotionEffects.add(new AlchemyPotionHandlerComponent(
				itemStack, potionID, tickDuration));
	}
	...
	public static boolean containsRegisteredPotionIngredient(
			ItemStack[] stackList) {
	...
	public static int getRegisteredPotionIngredientPosition(
			ItemStack[] stackList) {
		int i = 0;
